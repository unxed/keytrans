...
// translateModifiers maps an X11 state mask to vtinput ControlKeyState.
func translateModifiers(state uint16) vtinput.ControlKeyState {
...
var keysymToVKMap = map[uint32]uint16{
	...
	0xff55: vtinput.VK_PRIOR,
	0xff56: vtinput.VK_NEXT,
